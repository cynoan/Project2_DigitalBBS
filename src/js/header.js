(function () {
    document.getElementById("to_home").onclick = () => {
        window.parent.location = "index.html";
    };
    document.getElementById("to_news").onclick = () => {
        window.parent.location = "news.html";
    };
    document.getElementById("to_article").onclick = () => {
        window.parent.location = "article.html";
    };
    document.getElementById("to_interest").onclick = () => {
        window.parent.location = "interest.html";
    };

    let logo = document.getElementById("nav_left");
    logo.onclick = () => {
        logo.firstElementChild.style.animation = "logo1 0.6s";
        logo.firstElementChild.addEventListener("webkitAnimationEnd",()=>{
            logo.firstElementChild.style.animation = "";
            logo.lastElementChild.style.animation = "logo2 0.2s ease";
            logo.lastElementChild.addEventListener("webkitAnimationEnd",()=>{
            logo.lastElementChild.style.animation = "";
        });
        });
    }
})();
...
function close_login() {
    function fun() {
        ...
        window.parent.document.body.children[0].style.height = "70px";
        uname.value = "";
        upwd.value = "";
